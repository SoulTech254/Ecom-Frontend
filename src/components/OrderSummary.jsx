...
const OrderSummary = ({ subtotal, savings = 0, shippingFee = 0 }) => {
  return (
    <div className="bg-white p-8 w-full border rounded-lg">
      ...
      <div className="flex justify-between mb-2 text-sm sm:text-base md:text-lg">
      ...
      <div className="border-y border-gray-300 py-4 flex justify-between font-semibold text-sm sm:text-base md:text-lg">
        <span>Total (VAT Inc.)</span>
        <span>Ksh {(subtotal + shippingFee).toFixed(2)}</span>
      </div>

      <div className="mt-8">
        <h3 className="font-bold mb-4 text-base sm:text-lg md:text-xl">
